...
Mobile.verifyElementText(findTestObject('Object Repository/M25SP3DGA-1039/03_TransferFromG1A/07_VerifyText - TRANSACT'),'TRANSACT')

Mobile.tap(findTestObject('Object Repository/M25SP3DGA-1039/03_TransferFromG1A/08_TapOnTransfer'), 0)

Mobile.delay(3)

Mobile.verifyElementText(findTestObject('Object Repository/M25SP3DGA-1039/03_TransferFromG1A/09_VerifyElementText - Transfer To'),'Transfer To')
...
Mobile.verifyElementText(findTestObject('Object Repository/M25SP3DGA-1039/03_TransferFromG1A/12_VerifyElementText - Transfer To'),'Transfer To')
...
Mobile.verifyElementText(findTestObject('Object Repository/M25SP3DGA-1039/03_TransferFromG1A/16_VerifyText - Enter recipient reference'),'Enter recipient reference')
...
Mobile.setText(findTestObject('Object Repository/M25SP3DGA-1039/03_TransferFromG1A/17_SetTextForG1AtoCASAoptional'), 'G1A_To_CASA_Optional',0)

Mobile.takeScreenshot('C:\\Users\\AMBRAN~1\\AppData\\Local\\Temp\\screenshot2471642506259329252.png')

Mobile.setText(findTestObject('Object Repository/M25SP3DGA-1039/03_TransferFromG1A/20.1_SetOptionalText'), 'G1A_To_CASA_Optional',	0)

Mobile.tap(findTestObject('Object Repository/M25SP3DGA-1039/03_TransferFromG1A/18_UserTapOnContinue'), 0)

Mobile.verifyElementText(findTestObject('Object Repository/M25SP3DGA-1039/03_TransferFromG1A/19_VerifyText - Confirmation'),'Confirmation')
...
Mobile.verifyElementText(findTestObject('Object Repository/M25SP3DGA-1039/03_TransferFromG1A/22_DecisionScreen - Transfer successful'),'Transfer successful')

Mobile.verifyElementText(findTestObject('Object Repository/M25SP3DGA-1039/03_TransferFromG1A/23_Verify - Reference ID'),'Reference ID')
